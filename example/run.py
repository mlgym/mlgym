...
def parse_args():
    ...
    return num_epochs, validation_mode, run_mode, text_logging_path, gs_config_path, evaluation_config_path, process_count, gpus, log_std_to_file, websocket_logging_servers


if __name__ == '__main__':
    num_epochs, validation_mode, run_mode, text_logging_path, gs_config_path, evaluation_config_path, process_count, gpus, log_std_to_file, websocket_logging_servers = parse_args()
