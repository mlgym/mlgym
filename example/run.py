...
def parse_args():
    ...
    parser.add_argument('--evaluation_config_path', type=str, required=True, help='Path to the evaluation config')
    ...
    return num_epochs, run_mode, dashify_logging_path, text_logging_path, gs_config_path, evaluation_config_path, process_count, gpus, log_std_to_file


if __name__ == '__main__':
    num_epochs, run_mode, dashify_logging_path, text_logging_path, gs_config_path, evaluation_config_path, process_count, gpus, log_std_to_file = parse_args()
