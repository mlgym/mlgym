...
CUDA_VISIBLE_DEVICES='1,2,3,4,5,6' accelerate launch --multi_gpu --gpu_ids 1,2,3,4,5,6 --num_processes=5 /cluster/home/mlgym/example/gpt2/huggingface_impl/gpt2_hug_impl_accelerate.py

CUDA_VISIBLE_DEVICES='1,2,3,4,5,6,7' accelerate launch --multi_gpu --gpu_ids 1,2,3,4,5,6,7 --num_processes=6 /cluster/home/mlgym/example/gpt2/huggingface_impl/gpt2_hug_impl_accelerate.py 

# accelerate launch --multi_gpu --gpu_ids 0,1,2,3,4,6,7 --num_processes=7 /cluster/home/mlgym/example/gpt2/huggingface_impl/gpt2_hug_impl_accelerate.py 