...
class ValidatorFactory:
    ...
    def get_nested_cv(gs_config: Dict[str, Any], cv_config: Dict[str, Any], grid_search_id: str,
                      blue_print_type: Type[BluePrint], run_mode: RunMode) -> NestedCV:
    ...
    def get_cross_validator(gs_config: Dict[str, Any], cv_config: Dict[str, Any], grid_search_id: str,
                            blue_print_type: Type[BluePrint], run_mode: RunMode) -> CrossValidation:
    ...
    @staticmethod
    def get_gs_validator(grid_search_id: str, run_mode: RunMode, ) -> GridSearchValidator:
        return GridSearchValidator(grid_search_id=grid_search_id, run_mode=run_mode)
