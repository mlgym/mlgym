...
class EarlyStopping(EarlyStoppingIF):
    ...
    def __init__(self, early_stopping_criterion_strategy: EarlyStoppingCriterionStrategyIF):
        self.early_stopping_criterion_strategy = early_stopping_criterion_strategy

    def is_stopping_criterion_fulfilled(self, eval_results: List[EvaluationBatchResult]) -> bool:
        return self.early_stopping_criterion_strategy.is_stopping_criterion_fulfilled(eval_results)
