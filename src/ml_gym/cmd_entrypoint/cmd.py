        ...
        if accelerator is None or accelerator.is_main_process:
            ...
            for blueprint in blueprints:
                ...
                gs_api_client.add_config_string(grid_search_id=blueprint.grid_search_id, config_name="model_card.json",
                                                config=json.dumps(ModelCardFactory.create_model_card(grid_search_id=blueprint.grid_search_id, exp_config = blueprint.config, gs_config = yaml.safe_load(gs_config_string))), experiment_id=blueprint.experiment_id,
                                                file_format=FileFormat.JSON)
